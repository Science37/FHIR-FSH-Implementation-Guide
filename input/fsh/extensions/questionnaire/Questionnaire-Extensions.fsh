...
* extension[setting].extension contains
 id 0..1 and 
    ...
    minValue 0..1 and 
    version 0..1
* extension[setting].extension[id] only Extension
...
* extension[setting].extension[label] only Extension
...
* extension[setting].extension[hidden] only Extension
...
* extension[setting].extension[description] only Extension
...
* extension[setting].extension[pattern] only Extension
...
* extension[setting].extension[unique] only Extension
...
* extension[setting].extension[disabled] only Extension
...
* extension[setting].extension[type] only Extension
...
* extension[setting].extension[value] only Extension
...
* extension[setting].extension[required] only Extension
...
* extension[setting].extension[maxLength] only Extension
...
* extension[setting].extension[minLength] only Extension
...
* extension[setting].extension[maxValue] only Extension
...
* extension[setting].extension[minValue] only Extension
