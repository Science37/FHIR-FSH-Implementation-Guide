Instance: Questionnaire-Item-Extension-Example-Select-V2
InstanceOf: QuestionnaireS37
Title: "Example : Questionnaire.Item-Select-V2"
Description: "Example : Questionnaire.Item-Select-V2"
Usage: #example
/* Form Level Information */
* status = #draft
* title = "Example : Questionnaire.Item Select-V2"
* name = "Example : Questionnaire.Item Select-V2"
* subjectType = #Patient
