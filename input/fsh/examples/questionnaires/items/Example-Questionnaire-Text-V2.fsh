Instance: Questionnaire-Item-Extension-Example-Text-V2
InstanceOf: QuestionnaireS37
Title: "Example : Questionnaire.Item-Text-V2"
Description: "Example : Questionnaire.Item-Text-V2"
Usage: #example
/* Form Level Information */
* status = #draft
* title = "Example : Questionnaire.Item Text-V2"
* name = "Example : Questionnaire.Item Text-V2"
* subjectType = #Patient
