...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'military-start-time']) &lt;= 1">extension with URL = 'military-start-time': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'military-end-time']) &lt;= 1">extension with URL = 'military-end-time': maximum cardinality of 'extension' is 1</sch:assert>
