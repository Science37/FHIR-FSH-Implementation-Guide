...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'MASTER_VISIT_PLAN']) &lt;= 1">extension with URL = 'MASTER_VISIT_PLAN': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'EXPECTED_VISIT_PLAN']) &lt;= 1">extension with URL = 'EXPECTED_VISIT_PLAN': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'VISIT']) &lt;= 1">extension with URL = 'VISIT': maximum cardinality of 'extension' is 1</sch:assert>
