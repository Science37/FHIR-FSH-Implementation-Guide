...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'site-id']) &lt;= 1">extension with URL = 'site-id': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'site-name']) &lt;= 1">extension with URL = 'site-name': maximum cardinality of 'extension' is 1</sch:assert>
