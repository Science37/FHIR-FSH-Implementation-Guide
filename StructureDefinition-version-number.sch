...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'version-number']) &lt;= 1">extension with URL = 'version-number': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'audit-trail-version']) &lt;= 1">extension with URL = 'audit-trail-version': maximum cardinality of 'extension' is 1</sch:assert>
