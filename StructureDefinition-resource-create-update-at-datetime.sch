...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'createdAt']) &lt;= 1">extension with URL = 'createdAt': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'updatedAt']) &lt;= 1">extension with URL = 'updatedAt': maximum cardinality of 'extension' is 1</sch:assert>
