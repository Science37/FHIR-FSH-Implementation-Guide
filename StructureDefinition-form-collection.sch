...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'formType']) &gt;= 1">extension with URL = 'formType': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'formType']) &lt;= 1">extension with URL = 'formType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'forms']) &lt;= 1">extension with URL = 'forms': maximum cardinality of 'extension' is 1</sch:assert>
